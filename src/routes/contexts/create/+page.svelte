    ...
    <Box class="md:w-3/5 w-full">
        <form class="flex flex-col p-4 gap-4" use:enhance>
            ...
            <div>
                ...
                <input type="text" id="name" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white" required>
            </div>
            <div>
                <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Description</label>
                <textarea id="description" name="description" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white" required />
            </div>
            <div>
                <label for="type" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Type</label>
                <div class="flex items-center mb-2">
                    <input id="type-option-1" bind:group={type} type="radio" name="type" value={1} class="w-4 h-4 border-gray-300 focus:ring-2  dark:bg-gray-700 " checked>
                    <label for="type-option-1" class="block ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                        Game
                    </label>
                </div>
                <div class="flex items-center mb-2">
                    <input id="type-option-2" bind:group={type} type="radio" name="type" value={2} class="w-4 h-4 border-gray-300 focus:ring-2 dark:bg-gray-700 " checked>
